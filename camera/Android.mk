...
ifeq ($(USE_DEVICE_SPECIFIC_CAMERA),true)
    ...
    ifneq ($(BUILD_TINY_ANDROID),true)
      ...
      LOCAL_C_INCLUDES+= $(call project-path-for,qcom-display)/$(TARGET_BOARD_PLATFORM)/msm8960/libgralloc
      LOCAL_C_INCLUDES+= $(call project-path-for,qcom-display)/$(TARGET_BOARD_PLATFORM)/msm8960/libgenlock
