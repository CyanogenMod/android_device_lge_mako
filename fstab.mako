...
/dev/block/platform/msm_sdcc.1/by-name/userdata     /data           ext4    nosuid,nodev,barrier=1,data=ordered,noauto_da_alloc     wait,encryptable=/dev/block/platform/msm_sdcc.1/by-name/metadata
